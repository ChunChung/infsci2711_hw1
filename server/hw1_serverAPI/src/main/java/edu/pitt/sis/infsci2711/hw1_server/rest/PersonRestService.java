package edu.pitt.sis.infsci2711.hw1_server.rest;
...
import edu.pitt.sis.infsci2711.hw1_server.business.PersonService;
import edu.pitt.sis.infsci2711.hw1_server.models.PersonDBModel;
import edu.pitt.sis.infsci2711.hw1_server.viewModels.Person;
...
public class PersonRestService {
	...
	public Response addPerson(final Person person) {
		...
		try {
			PersonDBModel personsDB = personService
					.add(convertViewModelToDB(person));
	...
	private List<Person> convertDbToViewModel(
			final List<PersonDBModel> personsDB) {
	...
	private Person convertDbToViewModel(final PersonDBModel personDB) {
		return new Person(personDB.getId(), personDB.getFirstName(),
